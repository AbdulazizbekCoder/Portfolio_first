...
<head>
    <meta charset="UTF-8">
    <title>Title</title>
    <link rel="stylesheet" href="{{asset('assets/errors/404.css')}}">
    <style>
        button {
            position: absolute;
            left: 50%;
...
<body>
<svg version="1.1" id="error-404-img" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
     x="0px"
